...
function quickWriteToTheFile($message){
    ...
    echo"Message written to file using file_put_contents";
}


writeToFile("This is a sample og message!!");
quickWriteToTheFile("This will write everything with a new message!!");
readFromFile();
?>
...
//handle form subbmissions to update user data
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $username = mysql_real_escape_string( $conn, link_identifier: $_POST['username']);
    $email = mysql_real_escape_string( $conn, link_identifier: $_POST['email']);
